      ...
      <Table.Cell align="right" width="108px">
        {props.canPatch ? (
          <Flex align="center" justify="between">
            <Tooltip content={`Decrement ${props.medal.name} medal`}>
              <Button
                variant="ghost"
            ...
            <Tooltip content={`Increment ${props.medal.name} medal`}>
              <Button variant="ghost" onClick={() => props.onIncrement(props.country.id, props.medal.name)}>
                <PlusIcon />
              </Button>
            </Tooltip>
          </Flex>
